!--------------------------------------------------------------------------------
!PHYSUNITS module - automated computation of dimensions and units in scientific programs
...
MODULE physunits
  ...
  IMPLICIT NONE
#ifdef PDOUBLE
  INTEGER, PRIVATE, PARAMETER :: Wprec = Selected_Real_Kind(P=12)
#else
...
! Use only integer dimensions
  INTEGER(Short), PARAMETER :: base = 1            ! Base denominator for fractional dimensions
...
#ifdef NOCHECK
  LOGICAL, PRIVATE, PARAMETER :: unitcheck = .false. ! Check units of arguements to INT, REAL, etc.
#else
